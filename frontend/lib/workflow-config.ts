...
export const workflowConfig: WorkflowConfig = {
  ...
  nodes: [
    ...
    // Orchestrator
    {
      ...
      type: "orchestrator",
      description:
        "Main orchestrator task that spawns 10 parallel shard workers and aggregates results",
    ...
    // Batch task (shards)
    {
      ...
      type: "batch",
      description:
        "10 parallel workers, each processing ~10K customers. Each shard loads its own data to avoid large payload transfers.",
    ...
    // Data sources
    {
      ...
      type: "task",
      description:
        "CRM data: customer info, company details, deal stage, sales data",
      position: { x: 100, y: 480 },
      details: [
        { label: "Records", value: "100,000" },
        {
          label: "Fields",
          value: "customer_id, company_name, industry, deal_stage, region",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      details: [
        ...
        {
          label: "Fields",
          value: "total_sessions, usage_pct, features_used, api_calls",
        },
      ],
    },
    {
      ...
      details: [
        ...
        {
          label: "Fields",
          value: "total_tickets, nps_score, avg_resolution_hrs",
        },
      ],
    },
    // Enrichment
    {
      ...
      type: "task",
      description:
        "Calculate health_score, churn_risk, and expansion_potential for each customer",
      position: { x: 400, y: 620 },
      details: [
        {
          label: "Calculations",
          value: "health_score, churn_risk, expansion_potential",
        },
    ...
    // Aggregate
    {
      ...
      type: "task",
      description:
        "Combine all shard results into final output with statistics",
      ...
      animationSequence: [
        {
          ...
          title: "API Trigger",
          description:
            "Frontend calls POST /trigger to start the workflow. Returns a run ID for polling status.",
        },
        {
          id: "step-2",
          ...
          description:
            "The merge_customer_data task starts. This is the main orchestrator that coordinates the parallel processing.",
        },
        {
          id: "step-3",
          ...
          description:
            "Orchestrator spawns 10 parallel process_shard tasks. Each shard handles ~10K customers based on hash of customer_id.",
        },
        {
          id: "step-4",
          activeNodes: [
          ...
          description:
            "Each shard loads all 4 CSV files and filters to only records belonging to its shard. This avoids large payload transfers between tasks.",
        },
        {
          id: "step-5",
          ...
          title: "Merge & Enrich",
          description:
            "Each shard merges records by customer_id and calculates health_score, churn_risk, and expansion_potential.",
        },
        {
          id: "step-6",
          ...
          description:
            "Orchestrator collects results from all 10 shards and aggregates into final output with 100K enriched customer profiles.",
        },
      ],
    },
  ],
